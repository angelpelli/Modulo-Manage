...
class task(models.Model):
    ...
    technology=fields.Many2many(comodel_name="manageangelpelli.technology", relation="technology_task", column1="tarea_id", column2="tecnologia_id")
...
class history(models.Model):
    ...
    def _get_used_technologies(self):
        for history in self:
            ...
            for task in history.task: # Para cada una de las tareas de la historia
                if not technologies:
...
class technology(models.Model):
    ...
    task=fields.Many2many(comodel_name = "manageangelpelli.task", relation = "technology_task", column1 = "tecnologia_id", column2 ="tarea_id" )
...
#Modelo para gestionar las integraciones con herramientas externas.Implementa métodos para sincronizar datos con herramientas como GitHub, Jira o Slack.
